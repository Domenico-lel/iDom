...
- Il componente parte prima dell'accesso a Windows, tramite un'attività pianificata come SYSTEM. File e chiave sono in `C:\Program Files\iDom Remote`, con accesso limitato a SYSTEM e amministratori. L'installer non cambia BIOS, risparmio energetico, firmware, firewall o impostazioni del router.
